...
export function MangaCard({
  ...
  return (
    <div
      ref={cardRef}
      className={cn("group relative transition-all duration-300 ease-snappy", className)}
        ...
        style={
          {
            ...
            width: `${cardWidth}px`,
            [direction === "left" ? "right" : "left"]: "calc(100% - var(--card-padding))",
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <div className="flex flex-wrap gap-1">
              ...
              {sortedGenres.length > 6 && <GenreBadge genre={`+${sortedGenres.length - 6}`} />}
            </div>
          </div>
        </div>
      </Card>
