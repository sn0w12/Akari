...
function ExternalLinks({ manga }: { manga: components["schemas"]["MangaResponse"] }) {
  return (
    <>
      {manga.aniId && (
        <a
                ...
                <ResponsiveModal desktop="popover">
                  ...
                  >
                    <ResponsiveModalPanel>
                      ...
                      {alternativeTitles.map((mangaName: string) => (
                        <p
            ...
            <div className="lg:w-1/2 flex flex-col justify-between">
              <div className="grid grid-cols-2 gap-2 mb-2">
                <div>
                  <div className="text-lg font-semibold">
                    {pluralize("Author", manga.authors.length)}:
                  </div>
                      ...
                      <Badge
                        ...
                        render={
                          <Link
                            to="/author/$authorId"
                            params={{
                              authorId: encodeURIComponent(author.replaceAll(" ", "-")),
                            }}
                          />
                        }
                      >
                ...
                <div>
                  ...
                  <MangaUpdatedAt updatedAt={manga.updatedAt} />
                </div>
                <div>
                  <div className="text-lg font-semibold">Views:</div>
                  <Badge variant={getViewsVariant(manga.views)}>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="my-2 flex-grow">
                  <ScoreDisplay mangaId={manga.id} rating={manga.rating} />
                </div>
              </div>
