...
export function ChaptersSectionServer({ chapters, mangaId }: { chapters: components["schemas"]["MangaChapterResponse"]; mangaId: string }) {
    const preferredScanlator =
        chapters.preferredScanlatorId ??
        chapters.chapters[0]?.scanlatorId ??
        1;
