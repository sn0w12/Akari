...
function Sidebar({
  ...
  if (isMobile) {
    return (
      <Drawer position={side} open={openMobile} onOpenChange={setOpenMobile}>
        <DrawerPopup
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block z-40 bg-sidebar"
      data-state={state}
    ...
    <SidebarMenuItem>
      ...
      >
        ...
        {(state !== "collapsed" || isMobile) && (
          <ChevronDown className={cn("h-4 w-4", isExpanded ? "rotate-0" : "-rotate-90")} />
        )}
      </SidebarMenuButton>
