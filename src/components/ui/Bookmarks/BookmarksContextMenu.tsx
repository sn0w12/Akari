    ...
    const loadBookmarks = async () => {
        ...
        data?.bookmarks.forEach((bookmark: Bookmark) => {
            ...
            processedBookmarks.push({
                ...
                link: `/manga/${bookmark.link_story.split("/")[4]}`,
                current_chapter: bookmark.chapter_numbernow,
                current_chapter_link: `/manga/${bookmark.link_chapter_now.split("/").slice(4, 6).join("/")}`,
                last_chapter: bookmark.chapterlastnumber,
                last_chapter_link: `/manga/${bookmark.link_chapter_last.split("/").slice(4, 6).join("/")}`,
                up_to_date: upToDate,
