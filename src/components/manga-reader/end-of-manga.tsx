...
export default function EndOfManga({
    ...
    return (
        <Card
            className={`flex flex-col w-auto md:w-full h-[70svh] md:h-[90svh] mx-4 md:mx-auto my-8 max-w-156 ${className}`.trim()}
            style={style}
        >
            <CardHeader>
