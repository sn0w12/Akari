...
export const Route = createFileRoute("/_default/privacy/")({
    head: () => {
        const { meta, links } = createMetadata({
            ...
            description:
                "Learn how Akari handles your data and privacy with Plausible Analytics.",
            ...
            <div className="flex-1 bg-background text-foreground">
                <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="prose dark:prose-invert">
                        ...
                        <p>
                            At Akari, we take your privacy seriously. This
                            Privacy Policy explains what information we collect
                            and how we use it when you visit our website or use
                            the Akari application.
                        </p>

                        <h2>1. Self Hosting</h2>
                        <p>
                            If you are self hosting Akari, the application will
                            request manga content from our API to provide you
                            with access to manga sources. No analytics data is
                            collected if self hosting. See the{" "}
                            <a
                        ...
                        <ul>
                            <li>
                                ...
                                Plausible Analytics to gather anonymized data on
                                website usage. No personal data is collected or
                                stored through this feature. Learn more about{" "}
                                <a
                            ...
                            <li>
                                ...
                                account token, are stored locally on your
                                device. These may be sent to our API to enable
                                features like bookmark syncing, but we do not
                                store or persist this data on our servers.
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                traffic is coming from (e.g., external
                                websites).
                            </li>
                            <li>
                                <strong>Demographics:</strong> Tracks data such
                                as location, operating systems, and browser
                                types.
                            </li>
                        </ul>
                        ...
                        <p>
                            Plausible Analytics is designed with privacy as a
                            core principle:
                        </p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <strong>No Cookies:</strong> Plausible does not
                                use cookies, ensuring no tracking occurs outside
                                of anonymized metrics.
                            </li>
                            <li>
                                <strong>No Personal Data Collection:</strong>{" "}
                                All data collected is anonymized and does not
                                include personal identifiers like IP addresses
                                or names.
                            </li>
                            <li>
                        ...
                        <p>
                            As a user, you can control how your data is managed:
                        </p>
                        <ul>
                            <li>
                                <strong>Analytics Control:</strong> You can
                                disable sending analytics data at any time
                                through the settings. Navigate to Settings to
                                toggle analytics on or off according to your
                                preferences.
                            </li>
                        </ul>
                        ...
                        <p>
                            ...
                            operational, legal, or regulatory reasons. Any
