...
export const Route = createFileRoute("/_default/manga/$mangaId/$scanlator/$subId/")({
  validateSearch: (search: Record<string, string | undefined>): { page?: string | number } => {
    const page = search.page;
    return typeof page === "string" || typeof page === "number" ? { page } : {};
  },
  loader: async ({ params }) =>
    loadChapter({
      data: {
...
function MangaReaderPage() {
  ...
  return (
    <div className="bg-background text-foreground">
      <MangaReaderBody data={data} error={error} params={{ mangaId, scanlator, subId }} />
      <div className="p-4">
