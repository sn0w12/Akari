...
export async function fetchMangaDetails(id: string): Promise<MangaDetails> {
    ...
    if (cachedData) {
        return cachedData as MangaDetails;
    }
...
export async function GET(
    ...
    try {
        ...
        const mangaDetails = await fetchMangaDetails(params.id);
